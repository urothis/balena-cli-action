...
RUN apt-get update && apt-get install -y \
    ...
    unzip && \
  cd /opt/ && \
  export BALENA_RELEASE="$LATEST_CLI" BALENA_RELEASE="$LATEST_CLI" BALENA_RELEASE="v12.50.1" && \BALENA_RELEASE="v12.50.1" && \ \BALENA_RELEASE="$LATEST_CLI" BALENA_RELEASE="v12.50.1" && \BALENA_RELEASE="v12.50.1" && \ \ \
